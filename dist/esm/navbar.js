...
var __vue_render__$2 = function () {
    var _vm = this; var _h = _vm.$createElement; var _c = _vm._self._c || _h; return _c('div', {directives: [{name: 'click-outside', rawName: 'v-click-outside', value: (_vm.closeMenu), expression: 'closeMenu'}],
        ...
        on: {'click': function ($event) { $event.preventDefault(); _vm.newActive = !_vm.newActive }}}, [(_vm.label) ? [_vm._v(_vm._s(_vm.label))] : _vm._t('label')], 2), _vm._v(' '), _c('div', {directives: [{name: 'show', rawName: 'v-show', value: (!_vm.collapsible || (_vm.collapsible && _vm.newActive)), expression: '!collapsible || (collapsible && newActive)'}],
